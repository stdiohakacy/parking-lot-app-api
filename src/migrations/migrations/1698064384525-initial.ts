...
export class Initial1698064384525 implements MigrationInterface {
    name = 'Initial1698064384525';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "parking_tickets" ADD CONSTRAINT "FK_63998a909fb9fd2b00741098378" FOREIGN KEY ("parkingSpotId") REFERENCES "parking_spot_vehicles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "parking_spot_vehicles" ADD CONSTRAINT "FK_a3aae7e94cea87e5097cafec829" FOREIGN KEY ("parkingTicketId") REFERENCES "parking_tickets"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `ALTER TABLE "parking_spot_vehicles" DROP CONSTRAINT "FK_a3aae7e94cea87e5097cafec829"`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "parking_tickets" DROP CONSTRAINT "FK_63998a909fb9fd2b00741098378"`
        );
        await queryRunner.query(
