...
export class Init1697909160165 implements MigrationInterface {
    name = 'Init1697909160165';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `CREATE TABLE "vehicles" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP DEFAULT now(), "deletedAt" TIMESTAMP, "createdBy" uuid, "updatedBy" uuid, "deletedBy" uuid, "licenseNo" character varying NOT NULL, "parkingSpotId" uuid, CONSTRAINT "PK_18d8646b59304dce4af3a9e35b6" PRIMARY KEY ("id"))`
        );
        await queryRunner.query(
        ...
        await queryRunner.query(
            `ALTER TABLE "parking-tickets" ADD CONSTRAINT "FK_a4208c97bcd29d29329a00d7ed1" FOREIGN KEY ("vehicleId") REFERENCES "vehicles"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
        );
        await queryRunner.query(
